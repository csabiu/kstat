...
#######################################################################
gsplit -d --lines=${lines_per_file} new.txt.sort firstsplit.
...
gsplit -d --lines=${lines_per_file} firstsplit2.${n}.sort secondsplit.${n}.
m=0
...
gsplit -d --lines=${lines_per_file} secondsplit2.${n}.${m}.sort thirdsplit.${n}.${m}.
p=0
